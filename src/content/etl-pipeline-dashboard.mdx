...
author: Joe
description: Enterprise data pipeline work that turns high-volume AI call data into real-time reporting and operational insight.
role: Full-stack platform engineer
focus: ETL architecture, analytics APIs, dashboard data models, and operational reporting.
impact: Powers reporting workflows over hundreds of thousands of daily calls for enterprise financial-services customers.
stack:
    - Node.js
    - PostgreSQL
    - Redis
