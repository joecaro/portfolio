...
//                     />
//                 </svg>
//                 arrows to carve up and down the wave to gain forward momentum.
//                 Use the{" "}
//                 <svg
//                     xmlns='http://www.w3.org/2000/svg'
//                     width='16'
...
//                     />{" "}
//                     arrow to slow down. Avoid the kooks at all costs!
//                 </svg>
//             </div>
//         </section>
//     );
...
//                     generateY = () =>
//                         Math.abs(Math.random()) * (screenHeight - 50);
...
//                     playerPos = {
//                         x: (playerPos.x +=
//                             dx * deltaTime * MOVEMENT_MULTIPLIER),
//                         y: (playerPos.y +=
//                             dy * deltaTime * MOVEMENT_MULTIPLIER),
//                     };
...
//                     if (dx < (MAXIMUM_SPEED * playerPos.y) / canvas.height)
//                         dx += 15;
//                     else dy += 4;
//                     if (dy < 0) dy += 10;
//                 };
...
//                     if (
//                         playerPos.x + playerWidth >= canvas.width &&
//                         arrowDown.current
//                     ) {
//                         dx = 0;
//                     }
